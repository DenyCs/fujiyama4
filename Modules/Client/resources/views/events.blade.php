                    ...
                    <div class="group relative bg-white dark:bg-neutral-900/80 border {{ $event->isActive() ? 'border-orange-200 dark:border-orange-600/20 hover:border-orange-400/50 dark:hover:border-orange-500/50' : 'border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700' }} rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-orange-500/5 shadow-sm">
                        ...
                        <div class="aspect-[16/10] overflow-hidden bg-gradient-to-br from-orange-100 dark:from-orange-900/30 to-neutral-100 dark:to-neutral-900">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-full {{ $event->isActive() ? 'bg-orange-500 text-white' : 'bg-neutral-200 dark:bg-neutral-700/90 text-neutral-600 dark:text-neutral-300' }}">
                                    @if($event->isActive())
