    ...
    <footer class="bg-neutral-100 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('client.home') }}#kategori" class="text-sm text-neutral-600 dark:text-neutral-500 hover:text-orange-500 transition-colors">Kategori</a></li>
            ...
            <div class="mt-10 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-center">
                <p class="text-xs text-neutral-500 dark:text-neutral-600">&copy; {{ date('Y') }} Fujiyama Ramen. All rights reserved.</p>
            </div>
        </div>
    </footer>
