...
<div class="app-wrapper">
    ...
    {{-- Top Navbar — Fujiyama Dark Theme --}}
            ...
            <nav class="mt-1">
                <ul class="nav sidebar-menu flex-column" role="menu">
                    ...
                    <li class="nav-item" x-show="search === '' || 'dashboard'.includes(search.toLowerCase())">
                        <a href="{{ route('admin.dashboard') }}" class="nav-link sidebar-parent-link font-semibold text-white {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                    ...
                    {{-- Grup 2: Operasional --}}
                    @php $isOperasionalActive = request()->routeIs('admin.orders.*') || request()->routeIs('admin.reservations.*'); @endphp
                    <li class="nav-item"
                        x-data="{ open: {{ $isOperasionalActive ? 'true' : 'false' }} }"
                        ...
                        <ul class="nav nav-treeview" x-show="open || search !== ''">
                            <li class="nav-item" x-show="search === '' || 'pesanan'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.orders.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-receipt"></i>
                                    <p>Pesanan</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'reservasi'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.reservations.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.reservations.*') ? 'active' : '' }}">
                    ...
                    {{-- Grup 3: Katalog --}}
                    @php $isKatalogActive = request()->routeIs('admin.menus.*') || request()->routeIs('admin.categories.*'); @endphp
                    <li class="nav-item"
                        x-data="{ open: {{ $isKatalogActive ? 'true' : 'false' }} }"
                        ...
                        <ul class="nav nav-treeview" x-show="open || search !== ''">
                            <li class="nav-item" x-show="search === '' || 'menu'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.menus.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.menus.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-utensils"></i>
                                    <p>Menu</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'kategori'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.categories.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                    ...
                    {{-- Grup 4: Konten Website --}}
                    @php $isKontenActive = request()->routeIs('admin.banners.*') || request()->routeIs('admin.events.*') || request()->routeIs('admin.about.*') || request()->routeIs('admin.gallery.*') || request()->routeIs('admin.testimonials.*') || request()->routeIs('admin.faqs.*') || request()->routeIs('admin.section-content.*'); @endphp
                    <li class="nav-item"
                        x-data="{ open: {{ $isKontenActive ? 'true' : 'false' }} }"
                        ...
                        <ul class="nav nav-treeview" x-show="open || search !== ''">
                            <li class="nav-item" x-show="search === '' || 'banner'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.banners.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.banners.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-image"></i>
                                    <p>Banner</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'event'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.events.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.events.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item" x-show="search === '' || 'tentang kami'.includes(search.toLowerCase()) || 'tentang'.includes(search.toLowerCase()) || 'kami'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.about.edit') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.about.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-info-circle"></i>
                                    <p>Tentang Kami</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'galeri'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.gallery.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.gallery.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-images"></i>
                                    <p>Galeri</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'testimoni'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.testimonials.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.testimonials.*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-star"></i>
                                    <p>Testimoni</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'faq'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.faqs.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.faqs.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item" x-show="search === '' || 'konten section'.includes(search.toLowerCase()) || 'konten'.includes(search.toLowerCase()) || 'section'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.section-content.edit') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.section-content.*') ? 'active' : '' }}">
                    ...
                    {{-- Grup 5: Pengaturan --}}
                    @php $isPengaturanActive = request()->routeIs('admin.settings.location.*') || request()->routeIs('admin.settings.branding*') || request()->routeIs('admin.settings.footer.*') || request()->routeIs('admin.social-links.*') || request()->routeIs('admin.activity-logs.*'); @endphp
                    <li class="nav-item"
                        x-data="{ open: {{ $isPengaturanActive ? 'true' : 'false' }} }"
                        ...
                        <ul class="nav nav-treeview" x-show="open || search !== ''">
                            <li class="nav-item" x-show="search === '' || 'lokasi'.includes(search.toLowerCase()) || 'jam buka'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.settings.location.edit') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.settings.location.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item" x-show="search === '' || 'branding'.includes(search.toLowerCase()) || 'logo'.includes(search.toLowerCase()) || 'favicon'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.settings.branding') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.settings.branding*') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-paint-brush"></i>
                                    <p>Branding</p>
                                </a>
                            </li>
                            <li class="nav-item" x-show="search === '' || 'footer'.includes(search.toLowerCase()) || 'copyright'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.settings.footer.edit') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.settings.footer.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item" x-show="search === '' || 'social media'.includes(search.toLowerCase()) || 'sosial'.includes(search.toLowerCase()) || 'media'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.social-links.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.social-links.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item" x-show="search === '' || 'log aktivitas'.includes(search.toLowerCase()) || 'log'.includes(search.toLowerCase()) || 'aktivitas'.includes(search.toLowerCase())">
                                <a href="{{ route('admin.activity-logs.index') }}" class="nav-link sidebar-child-link font-normal text-neutral-400 {{ request()->routeIs('admin.activity-logs.*') ? 'active' : '' }}">
    ...
    <main class="app-main">
        <div class="app-content">
            <div class="container-fluid">
                {{-- Page Header — distinct background with border --}}
                <div class="page-header row mb-4 mx-0 px-3 py-3 bg-white dark:bg-neutral-900 border-bottom rounded-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h3 class="mb-0 fw-bold fs-2 text-neutral-900 dark:text-white">@yield('page_title', 'Dashboard')</h3>
                    </div>
