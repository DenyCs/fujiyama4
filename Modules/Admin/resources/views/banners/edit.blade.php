            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Deskripsi singkat banner...">{{ old('description', $banner->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($banner->image)
                    <div class="mb-2">
                        <img src="{{ $banner->image_url }}" alt="Current" style="max-width: 300px; border-radius: 8px;" class="mb-2">
                        <p class="text-muted small">Gambar saat ini. Upload file baru hanya jika ingin mengganti.</p>
                    </div>
                    @endif
                    ...
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="text-muted">Rekomendasi ukuran: 1600×900px (landscape lebar). Format: JPG, PNG, WebP. Maks 2MB. Kosongkan jika tidak ingin mengganti gambar.</small>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="cta_text" id="cta_text" class="form-control @error('cta_text') is-invalid @enderror"
                        value="{{ old('cta_text', $banner->cta_text) }}" maxlength="255">
                    @error('cta_text')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="cta_link" id="cta_link" class="form-control @error('cta_link') is-invalid @enderror"
                        value="{{ old('cta_link', $banner->cta_link) }}" maxlength="255"
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                        ...
                        <option value="inactive" {{ old('status', $banner->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
