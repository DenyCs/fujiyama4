...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Form Tambah Testimoni</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="order_type" id="order_type" class="form-control @error('order_type') is-invalid @enderror"
                        value="{{ old('order_type') }}" maxlength="255" placeholder="Contoh: Tonkotsu Ramen, Chicken Katsu">
                    @error('order_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="review" id="review" rows="4" class="form-control @error('review') is-invalid @enderror"
                    required placeholder="Tulis review dari pelanggan...">{{ old('review') }}</textarea>
                @error('review')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
