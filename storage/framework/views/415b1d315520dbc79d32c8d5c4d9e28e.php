<?php $__env->startSection('title', 'Keranjang Belanja — Fujiyama Ramen'); ?>

<?php $__env->startSection('content'); ?>
<div x-data="cartPage()" class="min-h-screen pt-20 pb-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-10">
            <h1 class="text-3xl md:text-4xl font-black font-['Noto_Sans_JP'] text-white mb-2">Keranjang</h1>
            <p class="text-neutral-400">Review pesananmu sebelum checkout.</p>
        </div>

        <!-- Empty Cart (hidden when items exist) -->
        <div x-show="items.length === 0" x-cloak class="text-center py-20">
            <div class="text-6xl mb-6">🛒</div>
            <h2 class="text-2xl font-bold text-white mb-3">Keranjang Kosong</h2>
            <p class="text-neutral-500 mb-8">Sepertinya kamu belum menambahkan menu apapun.</p>
            <a href="<?php echo e(route('client.home')); ?>#menu-unggulan"
        ...
        <div>
            <!-- Cart Table -->
            <div class="bg-neutral-900/80 border border-neutral-800 rounded-2xl overflow-hidden mb-8">
                            ...
                            <tr class="border-b border-neutral-800/50 hover:bg-neutral-800/30 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 class="text-sm font-bold text-white" x-text="item.name"></h3>
                                ...
                                <td class="px-6 py-4 text-center text-sm text-neutral-300" x-text="formatRupiah(item.price)"></td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <button @click="decreaseQty(item.id)"
                                            class="w-8 h-8 flex items-center justify-center rounded-lg bg-neutral-800 hover:bg-neutral-700 text-neutral-400 hover:text-orange-400 transition-colors text-lg font-bold leading-none">
                                            −
                                        </button>
                                        <span class="w-10 h-8 flex items-center justify-center text-sm font-semibold text-white bg-neutral-800 border border-neutral-700 rounded-lg"
                                ...
                                <td class="px-6 py-4 text-center text-sm font-bold text-orange-400" x-text="formatRupiah(item.subtotal)"></td>
            ...
            <div class="flex flex-col md:flex-row justify-end gap-6">
                <div class="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-6 w-full md:w-80">
                    <div class="flex justify-between items-center mb-4 pb-4 border-b border-neutral-800">
                        <span class="text-sm text-neutral-400">Total Item</span>
                        <span class="text-sm font-semibold text-white" x-text="totalItems"></span>
                    </div>
                    <div class="flex justify-between items-center mb-6">
                        <span class="text-lg font-bold text-white">Total</span>
                        <span class="text-2xl font-black text-orange-400" x-text="totalText"></span>
                    </div>
                    ...
                    <a href="<?php echo e(route('client.home')); ?>#menu-unggulan"
                        class="block w-full text-center mt-3 py-3 bg-neutral-800 hover:bg-neutral-700 text-neutral-300 text-sm font-medium rounded-xl transition-colors">
                        ← Lanjutkan Belanja
                    </a>
                </div>
            </div>
...
function cartPage() {
    return {
        ...
        totalItems: <?php echo e($cart->items->sum('qty')); ?>,
...
<?php echo $__env->make('client::layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\fujiyama4\Modules/Cart\resources/views/index.blade.php ENDPATH**/ ?>