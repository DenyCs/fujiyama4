...
<head>
    ...
    <?php if($restaurantSetting->favicon_image): ?>
        <link rel="icon" type="image/png" href="<?php echo e(asset($restaurantSetting->favicon_image)); ?>">
    <?php endif; ?>
    ...
    <nav x-data="{ open: false, scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 20)"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                <!-- Logo -->
                <a href="<?php echo e(route('client.home')); ?>" class="flex items-center gap-2 group shrink-0">
                    
                    <img x-show="theme === 'dark'"
                        src="<?php echo e($restaurantSetting->logo_dark ? asset($restaurantSetting->logo_dark) : ''); ?>"
                        alt="Fujiyama Ramen"
                        class="h-10 lg:h-12 w-auto object-contain"
                        <?php if(!$restaurantSetting->logo_dark): ?> style="display: none !important;" <?php endif; ?>
                    >
                    
                    <img x-show="theme === 'light'"
                        src="<?php echo e($restaurantSetting->logo_light ? asset($restaurantSetting->logo_light) : ''); ?>"
                        alt="Fujiyama Ramen"
                        class="h-10 lg:h-12 w-auto object-contain"
                        <?php if(!$restaurantSetting->logo_light): ?> style="display: none !important;" <?php endif; ?>
                    >
                    
                    <span x-show="(theme === 'dark' && !<?php echo e($restaurantSetting->logo_dark ? 'true' : 'false'); ?>) || (theme === 'light' && !<?php echo e($restaurantSetting->logo_light ? 'true' : 'false'); ?>)"
                        ...
                        <?php if($restaurantSetting->logo_dark && $restaurantSetting->logo_light): ?> style="display: none !important;" <?php endif; ?>
                    >FujiYama4</span>
                </a>
    ...
    <footer class="bg-neutral-100 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800 pb-20 lg:pb-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-neutral-600 dark:text-neutral-500 leading-relaxed">
                        <?php echo e($restaurantSetting->footer_description ?? 'Authentic Japanese ramen experience. Handcrafted noodles, rich broth, and premium toppings — crafted with passion since 2015.'); ?>
                ...
                <div class="hidden md:block">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="<?php echo e(route('client.events')); ?>" class="text-sm text-neutral-600 dark:text-neutral-500 hover:text-orange-500 transition-colors">Event & Promo</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-neutral-600 dark:text-neutral-500">
                        <li class="flex items-center gap-2">
                            ...
                            <?php echo e($restaurantSetting->address ?? 'Jl. Ramen No. 123, Jakarta'); ?>

                        </li>
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            <?php echo e($restaurantSetting->phone ?? '0812-3456-7890'); ?>
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <?php echo e($restaurantSetting->getOpeningHoursSummary()); ?>

                        </li>
                    </ul>

                    <?php if(isset($socialLinks) && $socialLinks->count()): ?>
                    <div class="mt-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="<?php echo e($link->url); ?>" target="_blank" rel="noopener noreferrer"
                               ...
                               title="<?php echo e($link->platform); ?>"
                               aria-label="<?php echo e($link->platform); ?>">
                                
                                <?php if($link->icon_identifier === 'instagram'): ?>
            ...
            <div class="mt-10 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-center">
                <p class="text-xs text-neutral-500 dark:text-neutral-600">&copy; <?php echo e(date('Y')); ?> <?php echo e($restaurantSetting->copyright_text ?? 'Fujiyama Ramen. All rights reserved.'); ?></p>
            </div>
        </div>
    </footer>
