        ...
        <div class="mt-8 bg-neutral-900 border border-neutral-800 rounded-xl p-6">
            ...
            <?php if($cart->items->isEmpty()): ?>
                <div class="text-neutral-400 text-sm py-4 text-center border border-dashed border-neutral-700 rounded-lg">
                    Belum ada menu dipilih. <a href="<?php echo e(route('client.menu')); ?>" class="text-orange-400 hover:text-orange-300 underline">Pilih menu dulu</a> jika ingin pre-order.
                </div>
            <?php else: ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between bg-neutral-800 rounded-lg p-3">
                            <div class="flex-1 min-w-0">
                                <p class="text-white text-sm font-medium truncate"><?php echo e($item->menu->name); ?></p>
                                <p class="text-neutral-400 text-xs"><?php echo e($item->qty); ?>x — Rp <?php echo e(number_format($item->menu->price, 0, ',', '.')); ?></p>
                            </div>
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>" class="block text-center text-sm text-orange-400 hover:text-orange-300 mt-1">
                        Edit keranjang →
                    </a>
                </div>
            <?php endif; ?>
