...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative min-h-screen overflow-hidden" x-data="heroSlider(<?php echo e($banners->count()); ?>)">
                    ...
                    <div class="max-w-3xl">
                        ...
                        <div class="flex items-center gap-2 mt-8">
                            ...
                            <button
                                ...
                                :class="current === <?php echo e($idx); ?> ? 'w-6 h-2 bg-orange-500 shadow-lg shadow-orange-500/40' : 'w-2 h-2 bg-neutral-500/60 hover:bg-neutral-400/80'"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group relative bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden hover:border-orange-600/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-600/5">
                    ...
                    <!-- Content -->
                    <div class="p-5">
                        <h3 class="text-lg font-bold text-neutral-900 dark:text-white mb-2 group-hover:text-orange-500 transition-colors"><?php echo e($menu->name); ?></h3>
                        <p class="text-sm text-neutral-500 dark:text-neutral-500 line-clamp-2 mb-4 leading-relaxed"><?php echo e($menu->description ?: 'Lezat, autentik, dan dibuat dengan bahan-bahan premium.'); ?></p>

                        <div class="flex items-center justify-between">
                            <span class="text-xl font-bold text-orange-600 dark:text-orange-400">Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?></span>
                            <button type="button"
