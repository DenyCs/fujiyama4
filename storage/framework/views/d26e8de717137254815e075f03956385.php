...
<?php $__env->startSection('content'); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <h2 class="text-4xl md:text-5xl lg:text-6xl font-black text-neutral-900 dark:text-white leading-[1.1] mb-5">
                        <?php echo e($about->title ?? 'Tentang Kami'); ?>
                    ...
                    <div class="max-w-md mb-8">
                        <div x-show="!expanded" x-transition>
                            <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed line-clamp-3">
                                <?php echo e($about->story); ?>

                            </p>
                            <?php if(strlen($about->story) > 300): ?>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex -space-x-2">
                            <?php $avColors = ['bg-orange-500', 'bg-amber-500', 'bg-red-400', 'bg-yellow-500']; $avInits = ['DR', 'SW', 'AR', 'NF']; ?>
                            <?php $__currentLoopData = $avInits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $init): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="w-9 h-9 rounded-full <?php echo e($avColors[$i]); ?> border-2 border-white dark:border-neutral-900 flex items-center justify-center text-[11px] font-bold text-white shadow-sm"><?php echo e($init); ?></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="order-1 lg:order-2 relative flex justify-center lg:justify-end">
                    ...
                    <div class="relative w-full max-w-md lg:max-w-lg">
                        <div class="relative z-10 rounded-3xl overflow-hidden"
                            ...
                            <img src="<?php echo e($heroPhoto->image_url); ?>"
                                alt="<?php echo e($heroPhoto->caption ?? 'Interior Fujiyama Ramen'); ?>"
                        ...
                        <div class="absolute -bottom-6 -left-6 z-20 w-36 h-44 md:w-44 md:h-52 rotate-[-3deg] rounded-2xl overflow-hidden border-4 border-white dark:border-neutral-800 shadow-xl">
                            <img src="<?php echo e($secondPhoto->image_url); ?>"
                                alt="<?php echo e($secondPhoto->caption ?? 'Interior Fujiyama'); ?>"
                ...
                <div class="absolute top-3 left-3 right-3 pointer-events-none">
                    <div class="flex flex-col gap-2">
                        ...
                        <span class="inline-flex items-center gap-1.5 self-start px-3 py-1.5 rounded-full text-xs font-bold backdrop-blur-xl
                            ...
                            <span class="relative flex h-2 w-2">
                                <span class="animate-ping absolute inline-flex h-full w-full rounded-full <?php echo e($isOpen ? 'bg-green-400' : 'bg-neutral-500'); ?> opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-2 w-2 <?php echo e($isOpen ? 'bg-green-400' : 'bg-neutral-500'); ?>"></span>
                            </span>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-4 p-4 bg-gradient-to-br from-white/80 to-orange-50/40 dark:from-neutral-800/80 dark:to-neutral-900/40 backdrop-blur-sm rounded-xl border border-orange-200/20 dark:border-orange-500/10">
                            ...
                            <div class="min-w-0">
                                ...
                                <a href="tel:<?php echo e($setting->phone); ?>" class="text-orange-600 dark:text-orange-400 font-semibold text-sm hover:underline transition">
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs text-neutral-500 dark:text-neutral-400"><?php echo e($todayLabel); ?> — Hari Ini</p>
                                            <?php $isClosed = (mb_strtolower(trim($todayFullSchedule)) === 'tutup'); ?>
                                            <p class="text-sm font-bold <?php echo e($isClosed ? 'text-red-500 dark:text-red-400' : 'text-neutral-800 dark:text-white'); ?>">
                                                <?php echo e($todayFullSchedule); ?>
                                        ...
                                        <div class="space-y-1.5">
                                            <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="flex items-center justify-between py-1 px-2 rounded text-xs
                                                    <?php echo e($isToday ? 'bg-orange-50 dark:bg-orange-900/20 font-semibold' : ''); ?>">
                                                    <span class="<?php echo e($isToday ? 'text-orange-600 dark:text-orange-400' : 'text-neutral-500 dark:text-neutral-400'); ?>">
                                                        <?php echo e($label); ?>

                                                        <?php if($isToday): ?><span class="ml-1 text-[10px]">• Hari Ini</span><?php endif; ?>
                                                    </span>
                                                    <span class="<?php echo e($isToday ? 'text-neutral-900 dark:text-white' : 'text-neutral-600 dark:text-neutral-300'); ?> <?php echo e($dayIsClosed ? 'text-red-500 dark:text-red-400' : ''); ?>">
                                                        <?php echo e($schedule); ?>
                ...
                <div class="relative">
                    ...
                    <div class="absolute top-4 right-4 z-20 w-[calc(100%-2rem)] max-w-[320px]
                        ...
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold
                                ...
                                <span class="relative flex h-1.5 w-1.5">
                                    ...
                                    <span class="relative inline-flex rounded-full h-1.5 w-1.5 <?php echo e($isOpen ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
                                </span>
                        ...
                        <div class="mb-3 drop-shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                            <p class="text-[10px] text-neutral-400 dark:text-neutral-500 mb-0.5"><?php echo e($todayLabel); ?> — Hari Ini</p>
                            <p class="text-sm font-bold <?php echo e($todayIsClosedDay ? 'text-red-500 dark:text-red-400' : 'text-orange-600 dark:text-orange-400'); ?>">
                                <?php echo e($todayFullSchedule); ?>
                        ...
                        <div class="space-y-1.5 mb-3">
                            <div class="flex justify-between items-center text-[10px] text-neutral-500 dark:text-neutral-400">
                                <span>Progress</span>
                                <span class="font-bold text-orange-600 dark:text-orange-400"><?php echo e($progressPercent); ?>%</span>
                            </div>
                            <div class="relative w-full h-2 bg-neutral-200/80 dark:bg-neutral-700/80 rounded-full overflow-hidden">
                                ...
                                <div class="absolute top-1/2 -translate-y-1/2 transition-all duration-700 ease-out"
                                    style="left: calc(<?php echo e($progressPercent); ?>% - 6px)">
                                    <span class="text-xs leading-none drop-shadow-sm">🍜</span>
                                </div>
                            </div>
                        </div>
                        <?php elseif($todayIsClosedDay): ?>
                        ...
                        <div class="flex items-start gap-2 mb-2.5 drop-shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                            ...
                            <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-snug line-clamp-2">
                                <?php echo e($setting->address ?? 'Alamat akan segera ditambahkan.'); ?>
                        ...
                        <div class="flex items-center gap-2 mb-3 drop-shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                            ...
                            <?php if($setting->phone): ?>
                            <a href="tel:<?php echo e($setting->phone); ?>" class="text-xs text-orange-600 dark:text-orange-400 font-medium hover:underline transition">
                                <?php echo e($setting->phone); ?>
                            ...
                            <div class="grid grid-cols-2 gap-1">
                                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center justify-between py-1 px-1.5 rounded text-[10px] leading-tight
                                        <?php echo e($isDayToday ? 'bg-orange-50 dark:bg-orange-900/20 font-semibold' : ''); ?>">
                                        <span class="mr-1 <?php echo e($isDayToday ? 'text-orange-600 dark:text-orange-400' : 'text-neutral-400 dark:text-neutral-500'); ?> truncate">
                                            <?php echo e(Str::limit($label, 3, '')); ?>

                                            <?php if($isDayToday): ?><span class="text-[8px] opacity-70">★</span><?php endif; ?>
                                        </span>
                                        <span class="text-right <?php echo e($isDayToday ? 'text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400'); ?> <?php echo e($dayIsClosed ? 'text-red-500 dark:text-red-400' : ''); ?>">
                                            <?php echo e($schedule); ?>
    ...
    >
        ...
        <?php if($testimonials->count()): ?>
            ...
            ?>
            <?php if($blurPhotos->count()): ?>
                <div class="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
                    
                    <?php if($blurPhotos->get(0)): ?>
                    <div class="absolute -top-8 left-[4%] w-40 md:w-64 h-40 md:h-64 rounded-2xl overflow-hidden opacity-25 md:opacity-30 -rotate-6 blur-xl grayscale">
                        <img src="<?php echo e($blurPhotos[0]->customer_photo_url); ?>" alt="" class="w-full h-full object-cover" loading="lazy">
                    </div>
                    <span class="absolute top-[100px] md:top-[130px] left-[10%] text-white/20 text-[10px] font-medium rotate-[-6deg] hidden md:block"><?php echo e($blurPhotos[0]->customer_name); ?></span>
                    <?php endif; ?>
                    
                    <?php if($blurPhotos->get(1)): ?>
                    <div class="absolute top-1/3 right-[3%] w-40 md:w-56 h-40 md:h-56 rounded-2xl overflow-hidden opacity-20 md:opacity-25 rotate-3 blur-xl grayscale hidden md:block">
                        <img src="<?php echo e($blurPhotos[1]->customer_photo_url); ?>" alt="" class="w-full h-full object-cover" loading="lazy">
                    </div>
                    <span class="absolute top-[55%] right-[15%] text-white/20 text-[10px] font-medium rotate-[3deg] hidden md:block"><?php echo e($blurPhotos[1]->customer_name); ?></span>
                    <?php endif; ?>
                    
                    <?php if($blurPhotos->get(2)): ?>
                    <div class="absolute bottom-[15%] left-[15%] w-36 md:w-48 h-36 md:h-48 rounded-2xl overflow-hidden opacity-20 blur-xl grayscale rotate-12 hidden md:block">
                        <img src="<?php echo e($blurPhotos[2]->customer_photo_url); ?>" alt="" class="w-full h-full object-cover" loading="lazy">
                    </div>
                    <?php endif; ?>
                    
                    <?php if($blurPhotos->get(3)): ?>
                    <div class="absolute top-[10%] right-[25%] w-32 md:w-44 h-32 md:h-44 rounded-2xl overflow-hidden opacity-20 -rotate-12 blur-xl grayscale hidden lg:block">
                        <img src="<?php echo e($blurPhotos[3]->customer_photo_url); ?>" alt="" class="w-full h-full object-cover" loading="lazy">
                    </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <?php if($testimonials->count()): ?>
                ...
                <div class="lg:hidden relative min-h-[260px]">
                    ...
                    <div
                        ...
                        :class="active === <?php echo e($i); ?> ? 'opacity-100' : 'opacity-0 pointer-events-none'"
                    >
                        ...
                        <div class="relative bg-neutral-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8">
                            ...
                            <div class="flex gap-0.5 mb-4 relative z-10">
                                <?php for($j = 1; $j <= 5; $j++): ?>
                                    <svg class="w-5 h-5 <?php echo e($j <= $testimonial->rating ? 'text-yellow-400' : 'text-neutral-700'); ?>" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex items-center gap-3 pt-5 border-t border-white/10">
                                ...
                                <?php endif; ?>
                                <div>
                                    <p class="font-semibold text-white text-sm"><?php echo e($testimonial->customer_name); ?></p>
                                    <?php if($testimonial->order_type): ?>
                                        <p class="text-xs text-neutral-500">Pesan: <?php echo e($testimonial->order_type); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="hidden lg:block relative lg:min-h-[340px]">
                    <?php $__currentLoopData = $testimonialPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIdx => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="absolute inset-0 grid grid-cols-3 gap-6 transition-opacity duration-300"
                        :class="desktopPage === <?php echo e($pageIdx); ?> ? 'opacity-100' : 'opacity-0 pointer-events-none'"
                    >
                        <?php $__currentLoopData = $page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative bg-neutral-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-orange-500/20 transition-all duration-300">
                            ...
                            <div class="flex gap-0.5 mb-4 relative z-10">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <svg class="w-5 h-5 <?php echo e($i <= $testimonial->rating ? 'text-yellow-400' : 'text-neutral-700'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                <?php endfor; ?>
                            </div>
                ...
                <div class="flex justify-end items-center gap-2 mt-6 mb-2 lg:hidden">
                    ...
                    <button
                        ...
                        class="rounded-full transition-all duration-300"
                        :class="active === <?php echo e($idx); ?> ? 'w-6 h-2 bg-orange-500 shadow-lg shadow-orange-500/40' : 'w-2 h-2 bg-neutral-600 hover:bg-neutral-500'"
                        aria-label="Testimoni <?php echo e($idx + 1); ?>"
                    ></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                ...
                <?php if($testimonialPages->count() > 1): ?>
                <div class="hidden lg:flex justify-end items-center gap-2 mt-10 mb-4">
                    <?php $__currentLoopData = $testimonialPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
                        @click="desktopPage = <?php echo e($idx); ?>"
                        class="rounded-full transition-all duration-300"
                        :class="desktopPage === <?php echo e($idx); ?> ? 'w-6 h-2 bg-orange-500 shadow-lg shadow-orange-500/40' : 'w-2 h-2 bg-neutral-600 hover:bg-neutral-500'"
                        aria-label="Halaman Testimoni <?php echo e($idx + 1); ?>"
                    ></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative w-full rounded-2xl md:rounded-3xl overflow-hidden h-64 md:h-96 shadow-2xl shadow-black/20">
                ...
                <div class="absolute inset-0 transition-all duration-500 ease-in-out"
                    :class="activeEventIndex === <?php echo e($index); ?>
                    ...
                    <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end">
                        ...
                        <span class="inline-block px-3 py-1 mb-3 bg-orange-500 text-white text-xs md:text-sm font-bold rounded-full w-fit shadow-lg shadow-orange-500/30">
                            <?php echo e($event->discount_promo); ?>
            ...
            <div class="relative mx-2 md:mx-4 -mt-6 z-20">
                <div class="bg-white dark:bg-neutral-900 rounded-xl md:rounded-2xl shadow-xl shadow-black/15 border border-neutral-200 dark:border-neutral-700/50 overflow-hidden">
                    <div class="flex items-center overflow-x-auto scrollbar-hide py-3 pl-3 pr-5 sm:pr-6 gap-2 md:gap-3">
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="switchEvent(<?php echo e($index); ?>)"
                            ...
                            <span class="text-sm md:text-base font-bold truncate w-full text-left"
                                :class="activeEventIndex === <?php echo e($index); ?> ? 'text-white' : ''">
                                <?php echo e($event->title); ?>

                            </span>
                            
                            <span class="text-xs mt-0.5"
                                :class="activeEventIndex === <?php echo e($index); ?> ? 'text-orange-100' : 'text-neutral-400 dark:text-neutral-500'">
                                <?php if($event->discount_promo): ?>
                                    🏷️ <?php echo e($event->discount_promo); ?> ·
                                <?php endif; ?>
                                <?php echo e($event->start_date->format('d M')); ?> — <?php echo e($event->end_date->format('d M')); ?>
                ...
                <?php if($faqs->count()): ?>
                    ...
                    <div class="md:hidden space-y-3">
                        ...
                        <div class="rounded-2xl overflow-hidden transition-all duration-300"
                            :class="selectedFaq === <?php echo e($index); ?>
                            ...
                            <button @click="selectedFaq = selectedFaq === <?php echo e($index); ?> ? -1 : <?php echo e($index); ?>"
                                ...
                                <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-300"
                                    :class="selectedFaq === <?php echo e($index); ?> ? 'rotate-90 text-orange-500' : 'text-neutral-400'"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/>
                                </svg>
                            </button>
                            <div x-show="selectedFaq === <?php echo e($index); ?>"
                                x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="hidden md:grid md:grid-cols-2 gap-8 lg:gap-10">
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button @click="selectedFaq = <?php echo e($index); ?>"
                                ...
                                <span class="text-sm md:text-base font-semibold leading-snug"
                                    :class="selectedFaq === <?php echo e($index); ?> ? 'text-white' : ''">
                                    <?php echo e($faq->question); ?>

                                </span>
                                <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-300"
                                    :class="selectedFaq === <?php echo e($index); ?> ? 'text-white translate-x-1' : 'text-neutral-400 dark:text-neutral-500 group-hover:translate-x-0.5'"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
