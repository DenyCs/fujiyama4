...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative py-8 md:py-16 overflow-hidden bg-neutral-100 dark:bg-neutral-900/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <?php echo $__env->make('client::partials.gallery-grid', ['galleries' => $allAboutGalleries, 'context' => 'fullpage', 'showFilter' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </section>
