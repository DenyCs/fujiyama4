        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <?php if($events->count()): ?>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group relative bg-neutral-900/80 border <?php echo e($event->isActive() ? 'border-orange-600/20 hover:border-orange-500/50' : 'border-neutral-800 hover:border-neutral-700'); ?> rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-orange-500/5">
                        <!-- Image -->
                        <div class="aspect-[16/10] overflow-hidden bg-gradient-to-br from-orange-900/30 to-neutral-900">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-full <?php echo e($event->isActive() ? 'bg-orange-500 text-white' : 'bg-neutral-700/90 text-neutral-300'); ?>">
