...
<?php $__env->startSection('title', 'Event & Promo — Fujiyama Ramen'); ?>

<?php $__env->startSection('content'); ?>
    <!-- Page Header -->
    <section class="relative pt-28 pb-12 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-neutral-100 dark:from-neutral-950 via-orange-100/30 dark:via-orange-950/20 to-neutral-100 dark:to-neutral-950"></div>
        <div class="absolute top-0 right-0 w-96 h-96 bg-orange-600/10 dark:bg-orange-600/5 rounded-full blur-3xl"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto">
                <span class="inline-block text-xs font-bold text-orange-600 dark:text-orange-400 uppercase tracking-[0.2em] mb-4">Event & Promo</span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black font-['Noto_Sans_JP'] text-neutral-900 dark:text-white mb-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <?php if($events->count()): ?>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group relative bg-white dark:bg-neutral-900/80 border <?php echo e($event->isActive() ? 'border-orange-200 dark:border-orange-600/20 hover:border-orange-400/50 dark:hover:border-orange-500/50' : 'border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700'); ?> rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-orange-500/5 shadow-sm">
                        <!-- Image -->
                        <div class="aspect-[16/10] overflow-hidden bg-gradient-to-br from-orange-100 dark:from-orange-900/30 to-neutral-100 dark:to-neutral-900">
                            <img src="<?php echo e($event->image_url); ?>" alt="<?php echo e($event->title); ?>"
                                class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            <!-- Status Badge -->
                            <div class="absolute top-4 left-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-full <?php echo e($event->isActive() ? 'bg-orange-500 text-white' : 'bg-neutral-200 dark:bg-neutral-700/90 text-neutral-600 dark:text-neutral-300'); ?>">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-extrabold text-neutral-900 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors mb-3">
                            ...
                            <div class="flex items-center gap-2 mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-800 text-sm text-neutral-500">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <h3 class="text-2xl font-bold text-neutral-900 dark:text-white mb-2">Belum Ada Event</h3>
...
<?php echo $__env->make('client::layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\fujiyama4\Modules\Client\app\Providers/../../resources/views/events.blade.php ENDPATH**/ ?>